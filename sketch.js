...
function setup() 
{
  ...
  blower.mouseClicked(airblow)
   ...
   star = createSprite(320,43,20,20);
   ...
   starDisplay = createSprite(45, 20, 30,30);
   starDisplay.scale = 0.2;
   starDisplay.addAnimation('empty', emptyStar)
   starDisplay.addAnimation('1', oneStar)
   starDisplay.addAnimation('2', twoStar)
...
function airblow(){
  Matter.Body.applyForce(fruit, {x:0, y:0},{x:0, y:-0.031})
  air.play()
}
